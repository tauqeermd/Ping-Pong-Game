...
class HandDetection():
    ...
    def create_trackbars(self):
        ...
        cv2.createTrackbar('HueMin', 'Trackbars', 16, 179, empty)
        cv2.createTrackbar('HueMax', 'Trackbars', 134, 179, empty)
        cv2.createTrackbar('SatMin', 'Trackbars', 71, 255, empty)
        cv2.createTrackbar('SatMax', 'Trackbars', 255, 255, empty)
        cv2.createTrackbar('ValMin', 'Trackbars', 163, 255, empty)
